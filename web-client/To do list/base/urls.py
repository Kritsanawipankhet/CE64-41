...
from .views import CustomLoginView, TaskList, TaskLists, ShareList, TaskDetail, ShareDetail, TaskCreate, ShareCreate, TaskUpdate, SuperTaskUpdate, ShareUpdate, SharingUpdate, TaskDeleteView, ShareDeleteView, CustomLoginView, RegisterPage
